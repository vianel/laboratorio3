...
CREATE TABLE `AREAS_COMUNES` (
  ...
  CONSTRAINT `FK_RELATIONSHIP_20` FOREIGN KEY (`CONDOMINIO_ID`) REFERENCES `CONDOMINIOS` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `CARTELERAS` (
  ...
  `TIPO_USUARIO_ID` varchar(10) NOT NULL,
  `FOTO` longblob NOT NULL,
...
INSERT INTO `INTERFACES` VALUES (1,'ActualizarPropietario','ActualizarPropietario','A'),(2,'Administrador','Administrador','A'),(3,'Agenda','Agenda','A'),(4,'AreaComun','Area Comun','A'),(5,'ComprobantePagoLicencia','ComprobantePagoLicencia.js','A'),(6,'Condominio','Condominio','A'),(7,'Empleados','Empleados','A'),(8,'Factura','Factura','A'),(9,'Inmueble','Inmueble','A'),(10,'Inventario','Inventario.','A'),(11,'Licencia','Licencia','A'),(12,'Login','Login','A'),(13,'Novedad','Novedad','A'),(14,'Pagarcondominio','Pagarcondominio.','A'),(15,'Pagoempleado','Pagoempleado','A'),(16,'Producto','Producto','A'),(17,'Renovacion','Renovacion','A'),(18,'Requisicion','Requisicion.','A'),(19,'Reservacion','Reservacion','A'),(20,'Sancion','Sancion','A'),(21,'ServicioComun','ServicioComun','A'),(22,'Sugerencia','Sugerencia','A'),(23,'MisionVision','Mision y Vision','A');
...
INSERT INTO `INTERFACES_POR_ROLES` VALUES (1,1,'actualizarpropietarioview','A'),(1,2,'administradorview','A'),(1,3,'agendaView','A'),(1,4,'areacomunview','A'),(1,5,'comprobantepagolicenciaView','A'),(1,6,'condominioView','A'),(1,7,'empleadosview','A'),(1,8,'facturaview','A'),(1,9,'inmuebleview','A'),(1,10,'inventarioView','A'),(1,11,'licenciaView','A'),(1,12,'loginView','A'),(1,13,'novedadview','A'),(1,15,'pagoempleadoview','A'),(1,16,'productoview','A'),(1,17,'renovacionView','A'),(1,18,'requisicionview','A'),(1,20,'sancionview','A'),(1,21,'serviciocomunView','A'),(1,23,'misionvisionview','A'),(2,14,'pagarcondominioview','A'),(2,19,'reservacionview','A'),(2,22,'sugerenciaview','A');
...
CREATE TABLE `PROPIETARIOS` (
  ...
  CONSTRAINT `FK_RELATIONSHIP_100` FOREIGN KEY (`CARGO_JUNTA_ONDOMINIO_ID`) REFERENCES `CARTELERAS` (`ID`),
  CONSTRAINT `FK_RELATIONSHIP_8` FOREIGN KEY (`CONDOMINIO_ID`) REFERENCES `CONDOMINIOS` (`ID`),
  CONSTRAINT `FK_RELATIONSHIP_86` FOREIGN KEY (`USUARIOS_ID`) REFERENCES `USUARIOS` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-01-20 17:28:01
